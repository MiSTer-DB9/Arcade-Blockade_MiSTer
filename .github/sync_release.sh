...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-Blockade_MiSTer.git"
CORE_NAME=(Arcade-Blockade)
...
UPSTREAM_CORE_NAME=(Arcade-Blockade)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-Blockade.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-Blockade.rbf)
